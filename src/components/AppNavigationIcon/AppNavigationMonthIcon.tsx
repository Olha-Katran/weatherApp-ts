...
const AppNavigationMonthIcon:React.FC<Props> = ({ active= false }) => (
    <svg
        width="24"
        height="24"
        viewBox="0 0 24 24"
    ...
    >
        <g clip-path="url(#clip0_6648_1378)">
            <path
...
export default AppNavigationMonthIcon;